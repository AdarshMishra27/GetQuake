...
import com.amworks.getquake.EarthquakeData;
...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link com.amworks.getquake.EarthquakeData} objects that has been built up from
    ...
    public static ArrayList<EarthquakeData> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray branch1=root.getJSONArray("features");
            for(int i=0;i<branch1.length();i++)
            {
                JSONObject branch2=branch1.getJSONObject(i);
                JSONObject branch3=branch2.getJSONObject("properties");
                float mag=(float)branch3.getDouble("mag");
                String place= (String) branch3.get("place");
                String [] parts2=place.split(",");
                String toBeDisplayed="";
                for(String x:parts2)
                    toBeDisplayed+=x+"\n";

                long timeInMilliseconds=branch3.getLong("time");
            ...
            Log.e("myApp", "Problem parsing the earthquake JSON results", e);
        }
